								...
								switch(currentC.receive_Choice1LabelFromS().getEnum()){
									...
									do {
										...
										switch(label3){
											...
											int payload13 = keyboard1.nextInt();
											...
											int payload16 = keyboard2.nextInt();
											...
											switch(currentC.receive_Choice1LabelFromS().getEnum()){
												...
												_summary_choice_retrieve:
												do {
													switch(currentC.receive_Choice2LabelFromS().getEnum()){
														case Choice2.DOT:
														Void payload18 = currentC.receive_DOTVoidFromS();
														System.out.println("RETR 3");
														//System.out.println(payload18);
														System.out.println("Received from S: .");
														continue _transaction;
														case Choice2.SUM:
														SUMString payload19 = currentC.receive_SUMStringFromS();
														//System.out.println("RETR 2");
											...
											int payload21 = keyboard3.nextInt();
											...
											int payload40 = keyboard4.nextInt();
